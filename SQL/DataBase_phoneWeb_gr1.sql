...
(
    ...
    -- VD: Điện thoại, Tai nghe, Sạc dự phòng
);
...
(
    ...
    Price DECIMAL(18, 0) NOT NULL
    -- Giá tại thời điểm mua (để tránh giá SP thay đổi sau này)
);
...
(
    ...
    OrderID INT FOREIGN KEY REFERENCES Orders(OrderID)
    -- Khi bán thì cập nhật OrderID vào đây
);
