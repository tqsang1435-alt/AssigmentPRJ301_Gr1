<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <footer class="footer">
            ...
            <div class="row">
                <div class="col l-2-4 m-4 c-6">
                    ...
                    <ul class="footer-list">
                        ...
                        <li class="footer-item">
                            <a href="#" class="footer-item__link">PhoneShop Blog</a>
                        </li>
                        <li class="footer-item">
                ...
                <div class="col l-2-4 m-4 c-6">
                    <h3 class="footer__heading">Về PhoneShop</h3>
                    <ul class="footer-list">
                        <li class="footer-item">
                            <a href="#" class="footer-item__link">Giới thiệu PhoneShop</a>
                        </li>
                        <li class="footer-item">
                ...
                <div class="col l-2-4 m-4 c-6">
                    ...
                    <ul class="footer-list">
                        <li class="footer-item">
                            <a href="#" class="footer-item__link">Điện thoại di động</a>
                        </li>
                        <li class="footer-item">
                            <a href="#" class="footer-item__link">Phụ kiện chính hãng</a>
                        </li>
                        <li class="footer-item">
                            <a href="#" class="footer-item__link">Sửa chữa và bảo hành</a>
                        </li>
                    </ul>
                </div>
                <div class="col l-2-4 m-4 c-6">
        ...
        <div class="footer__bottom">
            <div class="grid wide">
                <p class="footer__text">&copy; 2026 PhoneShop. Tất cả các quyền được bảo lưu.</p>
            </div>
        </div>
    </footer>