                        ...
                        <div class="ms-auto d-flex align-items-center">
                            <c:choose>
                                <c:when test="${not empty sessionScope.user}">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn user-dropdown-btn dropdown-toggle px-3 fw-bold" type="button"
                                            data-bs-toggle="dropdown"
                                            style="background-color: #ffc107; border-radius: 50px;">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end mt-2 shadow border-0"
                                            ...
                                            <li><a class="dropdown-item py-2" href="profile.jsp"><i
                                                        class="fa-solid fa-user-gear me-2 text-warning"></i>Hồ sơ cá
                                                    nhân</a></li>
                                            <li>
                                                <a class="dropdown-item py-2" href="order-history">
                                                    <i class="fa-solid fa-bag-shopping me-2 text-warning"></i>Lịch sử
                                                    mua hàng
                                                </a>
                                            </li>
                                            <li>
                                            ...
                                            <li><a class="dropdown-item text-danger fw-bold py-2" href="logout"><i
                                                        class="fa-solid fa-power-off me-2"></i>Đăng xuất</a></li>
                                        </ul>
                                    </div>
                                </c:when>
                                <c:otherwise>
                                    <a href="login.jsp" class="btn btn-outline-warning rounded-pill px-4 fw-bold">Đăng
                                        nhập</a>
                                </c:otherwise>
                            </c:choose>
                        </div>
