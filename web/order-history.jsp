...
<html>
    <head>
        ...
        <style>
            ...
            .status-1 { background-color: #ffc107; color: #000; } /* Chờ xác nhận */
            .status-2 { background-color: #0dcaf0; color: #000; } /* Đang giao */
            .status-3 { background-color: #dc3545; color: white; } /* Đã hủy */
            .status-4 { background-color: #198754; color: white; } /* Hoàn thành */
            .status-0 { background-color: #6c757d; color: white; } /* Khác */
                                    ...
                                    <c:forEach items="${orderList}" var="o" varStatus="loop">
                                        <tr>
                                            ...
                                            <td class="text-muted small">
                                                ...
                                                <c:out value="${not empty o.shippingAddress ? o.shippingAddress : 'Chưa cập nhật'}" />
                                            </td>
                                            
                                            <td>
                                                <span class="badge rounded-pill status-${o.status} px-3 py-2">
                                                    <c:choose>
                                            ...
                                            <td class="text-center">
                                                <a href="order-detail?id=${o.orderID}" class="btn btn-sm btn-outline-dark rounded-pill px-3">
