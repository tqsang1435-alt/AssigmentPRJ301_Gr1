                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <c:choose>
                                <c:when test="${payMode == 'cart'}">
                                    <p class="text-muted mb-1">Thanh toán giỏ hàng (${sessionScope.cartCount} sản phẩm)
                                    </p>
                                    <h2 class="price-highlight mb-4">
                                        <fmt:formatNumber value="${sessionScope.totalMoney}" groupingUsed="true" /> đ
                                    </h2>
                                </c:when>
                                <c:otherwise>
                                    <p class="text-muted mb-1">Sản phẩm: <b>${quickProduct.productName}</b></p>
                                    <h2 class="price-highlight mb-4">
                                        <fmt:formatNumber value="${quickProduct.price}" groupingUsed="true" /> đ
                                    </h2>
                                </c:otherwise>
                            </c:choose>

                            <div class="qr-box mb-4">
                                <img src="images/z7584199724359_2ba6e8eb185f11c1be664a43d11653ad.jpg" alt="Mã QR"
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <form action="checkout" method="POST">
                                    ...
                                    <button type="submit"
                                        class="btn btn-link text-muted text-decoration-none small w-100">
