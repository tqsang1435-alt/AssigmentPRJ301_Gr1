            ...
            <form action="user-register" method="POST">
                    ...
                    <div class="col c-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" class="form-control" placeholder="Nhập SĐT (10 số)" 
                                required pattern="\d{10}" title="Vui lòng nhập đúng 10 chữ số" value="${param.phone}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control" placeholder="Nhập email (@gmail.com)" 
                        required pattern=".+@gmail\.com" title="Email phải có đuôi @gmail.com" value="${param.email}">
                </div>

                <div class="form-group">
                    <label class="form-label">Địa chỉ <span style="color: red;">*</span></label>
                    <input type="text" name="address" class="form-control" placeholder="Nhập địa chỉ" 
                        required oninvalid="this.setCustomValidity('Vui lòng nhập địa chỉ giao hàng')" 
                ...
                <div class="auth-switch">
                    ...
                    <a href="${pageContext.request.contextPath}/user-login" class="auth-switch__link">Đăng nhập tại đây</a>
                </div>
            </form>
        </div>
    </div>
